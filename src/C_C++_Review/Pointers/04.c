/**
 * @brief Demonstrate NULL pointer initialization and safe usage.
 *
 * @details
 *   - Initialize pointers to NULL when they don't yet point to valid data.
 *   - Check for NULL before dereferencing to avoid crashes.
 *   - Enable graceful handling of uninitialized or failed allocations.
 */
